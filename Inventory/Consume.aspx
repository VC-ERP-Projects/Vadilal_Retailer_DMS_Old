<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="Consume.aspx.cs" Inherits="Inventory_Consume" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Checkvalidation() {
            ...
            if (Number(totQty) == 0) {
                ModelMsg('Consume Quantity must be a greater than Zero', 3);
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="panel panel-default">
        <div class="panel-body _masterForm">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox runat="server" ID="txtAmount" TabIndex="3" CssClass="txtAmount form-control" Enabled="false" Text="0" />
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        <asp:Label ID="lblwarehouse" Text="Warehouse" CssClass="input-group-addon" runat="server"></asp:Label>
                        <asp:DropDownList runat="server" ID="ddlWhs" TabIndex="4" DataValueField="WhsID" DataTextField="WhsName" CssClass="form-control"
            ...
            <div class="row">
                <div class="col-lg-12 _textArea">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox runat="server" ID="txtNotes" TabIndex="5" TextMode="MultiLine" CssClass="form-control" Style="resize: none;" />
                    </div>

                </div>
            </div>
            <asp:TextBox runat="server" placeholder="Search here" TabIndex="6" ID="txtSearch" CssClass="txtSearch form-control" />
            <br />
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Available Qty">
                        <ItemTemplate>
                            ...
                            <asp:TextBox ID="txtAvailQty" CssClass="txtAvailQty form-control" Text='<%# Eval("AvailQty") %>' Enabled="false" runat="server"></asp:TextBox>
                        </ItemTemplate>
            ...
            <asp:Button Text="Cancel" ID="btnCancel" CssClass="btn btn-default" TabIndex="8" OnClick="btnCancel_Click" runat="server" UseSubmitBehavior="false" CausesValidation="false" />
        </div>
    </div>
</asp:Content>
