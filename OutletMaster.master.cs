...
public partial class OutletMaster : System.Web.UI.MasterPage
{
        ...
        using (var ctx = new DDMSEntities())
        {
            ...
            if (Request.QueryString["MID"] != null)
            {
                ...
                if (objOMNU != null)
                {
                    ...
                    lnkTitle.PostBackUrl = ctx.OMNUs.FirstOrDefault(x => x.MenuID == objOMNU.ParentMenuID.Value).MenuPath;
