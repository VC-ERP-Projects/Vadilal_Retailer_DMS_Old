<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="PurchaseDelivery.aspx.cs" Inherits="Sales_PurchaseDelivery" %>
        ...
        function ChangeQuantity(txt) {
            ...
            for (var i = 0; i < AllRows.length; i++) {
                ...
                if (txt == undefined) {
                    ...
                    var Data = new Array();
                    if ($('.hdnType').val() == "2") {
                        DisptchQty = $(AllRows[i]).find('.txtRequestQty').val()
