<%@ Page Language="C#" MasterPageFile="~/ReportMaster.master" AutoEventWireup="true" CodeFile="SalesRegister.aspx.cs" Inherits="Reports_SalesRegister" EnableEventValidation="false" %>
            ...
            <div class="row _masterForm">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList ID="ddlInvoiceType" runat="server" TabIndex="7" CssClass="ddlInvoiceType form-control">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList runat="server" ID="ddlDocType" TabIndex="8" CssClass="ddlDocType form-control">
