<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="MaterialMasterReport.aspx.cs" Inherits="Reports_MaterialMasterReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="panel">
        <div class="panel-body  _masterForm">
            ...
            <iframe id="ifmMaterial" style="width: 100%" class="embed-responsive-item" runat="server" onload="ifmMaterial_Load"></iframe>
        </div>
    </div>
</asp:Content>
