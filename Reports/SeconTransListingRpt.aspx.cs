...
public partial class Reports_SeconTransListingRpt : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmDataReq.Attributes.Add("src", "../Reports/ViewReport.aspx?&SeconTransFromDate=" + txtFromDate.Text + "&SeconTransToDate=" + txtToDate.Text + "&SeconTransRegionID=" + RegionID + "&SeconTransDistID=" + DistID + "&SeconTransDealerID=" + DealerID);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        DistID = CustType == 1 ? (Decimal.TryParse(txtCustCode.Text.Split("-".ToArray()).Last().Trim(), out DistID) ? DistID : 0) : ParentID;
        DealerID = Decimal.TryParse(txtDealerCode.Text.Split("-".ToArray()).Last().Trim(), out DealerID) ? DealerID : 0;
        ifmDataReq.Attributes.Add("src", "../Reports/ViewReport.aspx?&SeconTransFromDate=" + txtFromDate.Text + "&SeconTransToDate=" + txtToDate.Text + "&SeconTransRegionID=" + RegionID + "&SeconTransDistID=" + DistID + "&SeconTransDealerID=" + DealerID + "&Export=1");
    }
}