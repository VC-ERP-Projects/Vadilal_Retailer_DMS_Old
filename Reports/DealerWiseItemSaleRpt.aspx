<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="DealerWiseItemSaleRpt.aspx.cs" Inherits="Reports_DealerWiseItemSaleRpt" %>
            ...
            <div class="row _masterForm">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList runat="server" ID="ddlSaleBy" TabIndex="4" CssClass="ddlSaleBy form-control" onchange="ChangeReportFor(this);">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        <asp:Label ID="lblIsDetail" runat="server" Text="Select Type" CssClass="input-group-addon"></asp:Label>
                        <asp:DropDownList ID="chkIsDetail" runat="server" TabIndex="8" CssClass="form-control">
                            <asp:ListItem Text="Dealer + Item + Invoice wise" Value="1"></asp:ListItem>
                            <asp:ListItem Text="Dealer + Item wise" Value="2"></asp:ListItem>
                            <asp:ListItem Text="Dealer wise" Value="3"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4">
