...
public partial class Reports_InvoiceWiseItemSaleReturn : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmInvoicewiseItemSaleReturn.Attributes.Add("src", "../Reports/ViewReport.aspx?IvnWiseItmSaleReturnFromDate=" + txtFromDate.Text + "&IvnWiseItmSaleReturnToDate=" + txtToDate.Text + "&IvnDistributorID=" + DistID + "&IvnDealerID=" + DealerID + "&IvnDivisionID=" + ddlDivision.SelectedValue + "&IsDetail=" + IsDetail + "&CompCust=" + Distid);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        ifmInvoicewiseItemSaleReturn.Attributes.Add("src", "../Reports/ViewReport.aspx?IvnWiseItmSaleReturnFromDate=" + txtFromDate.Text + "&IvnWiseItmSaleReturnToDate=" + txtToDate.Text + "&IvnDistributorID=" + DistID + "&IvnDealerID=" + DealerID + "&IvnDivisionID=" + ddlDivision.SelectedValue + "&IsDetail=" + IsDetail + "&Export=1&CompCust=" + Distid);
    }

    protected void ifmInvoicewiseItemSaleReturn_Load(object sender, EventArgs e)
    {
