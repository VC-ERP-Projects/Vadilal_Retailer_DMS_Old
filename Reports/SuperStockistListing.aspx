<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="SuperStockistListing.aspx.cs" Inherits="Reports_SuperStockistListing" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="panel">
        <div class="panel-body">
            <div class="row _masterForm">
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList runat="server" ID="ddlSSStatus" CssClass="ddlSSStatus form-control" TabIndex="1">
            ...
            <iframe id="ifmSSListing" style="width: 100%" class="embed-responsive-item" runat="server" onload="ifmSSListing_Load"></iframe>
        </div>
    </div>
</asp:Content>
