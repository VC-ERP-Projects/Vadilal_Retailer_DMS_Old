<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="ItemWiseInvoicePurchaseRpt.aspx.cs" Inherits="Reports_ItemWiseInvoicePurchaseRpt" %>
        ...
        <div class="panel-body">
            <div class="row _masterForm">
                ...
                <div class="col-lg-4" id="divEmpCode" runat="server">
                    <div class="input-group form-group">
                        <asp:Label ID="lblCode" runat="server" Text="Employee" TabIndex="3" CssClass="input-group-addon"></asp:Label>
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        <asp:Label runat="server" ID="lblSaleBy" Text="Purchase By" CssClass="input-group-addon"></asp:Label>
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox runat="server" ID="txtItem" CssClass="txtItem form-control" TabIndex="7" Style="background-color: rgb(250, 255, 189);" Text='<%# String.Format("{0} - {1}", Eval("ItemCode"),Eval("ItemName")) %>' />
                        <asp:AutoCompleteExtender OnClientShown="resetPosition" CompletionListCssClass="CompletionListClass" ID="acettxtItem" runat="server" ServicePath="../Service.asmx" UseContextKey="true" ServiceMethod="GetItemWithID" MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="false" CompletionSetCount="1" TargetControlID="txtItem">
                        </asp:AutoCompleteExtender>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList ID="ddlDateOption" runat="server" TabIndex="8" CssClass="ddlDateOption form-control">
