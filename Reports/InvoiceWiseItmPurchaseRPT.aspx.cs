...
public partial class Reports_InvoiceWiseItmPurchaseRPT : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmItemWiseInvoicePurchase.Attributes.Add("src", "../Reports/ViewReport.aspx?InvoiceWiseItmPurchaseFromDate=" + txtFromDate.Text + "&InvoiceWiseItmPurchaseToDate=" + txtToDate.Text + "&IvnSSID=" + SSID + "&IvnDistributorID=" + DistributorID + "&IvnPurchaseBy=" + ddlPurchaseBy.SelectedValue + "&IvnDivisionID=" + ddlDivision.SelectedValue + "&IvnDateOption=" + ddlDateOption.SelectedValue + "&IsDetail=" + IsDetail + "&IvnSUserID=" + SUserID+ "&CompCust=" + CustomerId);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        Decimal CustomerId = DistributorID > 0 ? DistributorID : SSID;
        ifmItemWiseInvoicePurchase.Attributes.Add("src", "../Reports/ViewReport.aspx?InvoiceWiseItmPurchaseFromDate=" + txtFromDate.Text + "&InvoiceWiseItmPurchaseToDate=" + txtToDate.Text + "&IvnSSID=" + SSID + "&IvnDistributorID=" + DistributorID + "&IvnPurchaseBy=" + ddlPurchaseBy.SelectedValue + "&IvnDivisionID=" + ddlDivision.SelectedValue + "&IvnDateOption=" + ddlDateOption.SelectedValue + "&IsDetail=" + IsDetail + "&IvnSUserID=" + SUserID + "&Export=1&CompCust=" + CustomerId);
    }
