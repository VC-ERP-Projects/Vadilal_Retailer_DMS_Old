...
public partial class Reports_CallDuration : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void ifmCallDuration_Load(object sender, EventArgs e)
    {
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmCallDuration.Attributes.Add("src", "../Reports/ViewReport.aspx?CallDurationEmpID=" + SUserID + "&CallDurationDate=" + ToDate.ToShortDateString() + "&CallDurationEmpGrp=" + ddlEGroup.SelectedValue + "&CallDurationEMP=" + EmpID + "&FromDate=" + FromDate.ToShortDateString());
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        ifmCallDuration.Attributes.Add("src", "../Reports/ViewReport.aspx?CallDurationEmpID=" + SUserID + "&CallDurationDate=" + ToDate.ToShortDateString() + "&CallDurationEmpGrp=" + ddlEGroup.SelectedValue + "&CallDurationEMP=" + EmpID + "&Export=1" + "&FromDate=" + FromDate.ToShortDateString());
    }
    #endregion
}