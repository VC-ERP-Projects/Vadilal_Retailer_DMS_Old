...
public partial class Reports_WhsUtilizationReport : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmWhs.Attributes.Add("src", "../Reports/ViewReport.aspx?WarUtiMstActive=" + Active + "&CompCust=" + CustomerID);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        decimal CustomerID = !String.IsNullOrEmpty(Cust) ? ctx.OCRDs.FirstOrDefault(x => x.CustomerCode == Cust && x.ParentID == ParentID).CustomerID : 0;
        string Active = chkIsActive.Checked ? "1" : "0";
        ifmWhs.Attributes.Add("src", "../Reports/ViewReport.aspx?WarUtiMstActive=" + Active + "&CompCust=" + CustomerID + "&Export=1");

    }

    #endregion
    protected void ifmWhs_Load(object sender, EventArgs e)
    {
