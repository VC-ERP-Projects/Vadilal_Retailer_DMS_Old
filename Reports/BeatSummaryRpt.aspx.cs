...
public partial class Reports_BeatSummaryRpt : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmBeatSummary.Attributes.Add("src", "../Reports/ViewReport.aspx?EmpBeatSummaryFromDate=" + txtFromDate.Text + "&EmpBeatSummaryToDate=" + txtToDate.Text + "&EmpBeatSummaryRegionID=" + RegionID +
            "&EmpBeatSummarySUserID=" + SUserID + "&EmpBeatSummaryEmpGrpID=" + ddlEGroup.SelectedValue + "&BeatType=" + ddlBeatType.SelectedValue + "&IsDetail=" + IsDetail + "&EmpBeatSummaryEMP=" + EmpID +
            "&DealerType=" + ddlDealer.SelectedValue);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        ifmBeatSummary.Attributes.Add("src", "../Reports/ViewReport.aspx?EmpBeatSummaryFromDate=" + txtFromDate.Text + "&EmpBeatSummaryToDate=" + txtToDate.Text + "&EmpBeatSummaryRegionID=" + RegionID +
            "&EmpBeatSummarySUserID=" + SUserID + "&EmpBeatSummaryEmpGrpID=" + ddlEGroup.SelectedValue + "&BeatType=" + ddlBeatType.SelectedValue + "&IsDetail=" + IsDetail + "&EmpBeatSummaryEMP=" + EmpID + "&DealerType=" + ddlDealer.SelectedValue + "&Export=1");

    }

    protected void ifmBeatSummary_Load(object sender, EventArgs e)
    {
