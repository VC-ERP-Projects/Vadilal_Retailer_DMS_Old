<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="InvoiceWiseItmPurchaseReturnRPT.aspx.cs" Inherits="Reports_InvoiceWiseItmPurchaseReturnRPT" %>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="input-group form-group">
                        ...
                        <%--<asp:DropDownList ID="ddlDivision" runat="server" CssClass="ddlDivision form-control">
                            ...
                            <asp:ListItem Text="Dairy Product" Value="5" />
                        </asp:DropDownList>--%>
