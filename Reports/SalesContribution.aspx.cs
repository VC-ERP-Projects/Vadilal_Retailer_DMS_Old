...
public partial class Reports_SalesContribution : System.Web.UI.Page
{
    #region Declaration
    ...
    public void ClearAllInputs()
    {
        ...
        txtCode.Text = txtRegion.Text = txtPlant.Text = txtnodays.Text = "";
    }
    #endregion
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            divSS.Visible = divDistributor.Visible = divPlant.Visible = divRegion.Visible = divEmpCode.Visible = true;
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        {
            ifmsalerpt.Attributes.Remove("src");
        ...
        ifmsalerpt.Attributes.Add("src", "../Reports/ViewReport.aspx?SalesContriFromDate=" + txtFromDate.Text + "&SalesContriToDate=" + txtToDate.Text +
            "&SalesContriRegionID=" + RegionID.ToString() + "&SalesContriDistributorID=" + DistributorID.ToString() +
            "&SalesContriSSID=" + SSID.ToString() + "&SalesContriSaleBy=" + ddlSaleBy.SelectedValue + "&SalesContriSelectedEmpID=" + SUserID + "&SalesContriCustStatus=" + ddlDistStatus.SelectedValue);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        ifmsalerpt.Attributes.Add("src", "../Reports/ViewReport.aspx?SalesContriFromDate=" + txtFromDate.Text + "&SalesContriToDate=" + txtToDate.Text +
          "&SalesContriRegionID=" + RegionID.ToString() + "&SalesContriDistributorID=" + DistributorID.ToString() +
          "&SalesContriSSID=" + SSID.ToString() + "&SalesContriSaleBy=" + ddlSaleBy.SelectedValue + "&SalesContriSelectedEmpID=" + SUserID + "&SalesContriCustStatus=" + ddlDistStatus.SelectedValue + "&Export=1");
    }

    #endregion

    protected void ifmsalerpt_Load(object sender, EventArgs e)
    {
