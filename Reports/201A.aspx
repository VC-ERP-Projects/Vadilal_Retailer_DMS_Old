<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/OutletMaster.master" CodeFile="201A.aspx.cs" Inherits="Reports_201A" %>
    ...
    <script type="text/javascript">
        ...
        function TaxType() {
            if ($('.ddlReportType').val() != 1) {
                $('.ddlTaxType').attr('style', 'display:none;');
            }
            else {
                $('.ddlTaxType').removeAttr('style', 'display:block;');
            }
        }
            ...
            <div class="row _masterForm">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList runat="server" ID="ddlReportType" onchange="TaxType();" TabIndex="6" CssClass="ddlReportType form-control">
                            <asp:ListItem Value="1">Gross Sales</asp:ListItem>
                            <asp:ListItem Value="2">Sales Return</asp:ListItem>
                            <asp:ListItem Value="3">Net Sales</asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="ddlTaxType input-group form-group">
                        <asp:Label ID="lbltatType" runat="server" Text="Tax Type" CssClass="input-group-addon"></asp:Label>
                        <asp:DropDownList runat="server" ID="ddlTaxType" TabIndex="6" DataValueField="Key" CssClass="form-control" DataTextField="Value">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4">
