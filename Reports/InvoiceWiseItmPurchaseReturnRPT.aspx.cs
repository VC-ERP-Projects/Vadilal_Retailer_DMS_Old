...
public partial class Reports_InvoiceWiseItmPurchaseReturnRPT : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        Decimal CustomerId = DistributorID > 0 ? DistributorID : DistID;
        ifmItemWiseInvoicePurchase.Attributes.Add("src", "../Reports/ViewReport.aspx?InvoiceWiseItmPurchaseReturnFromDate=" + txtFromDate.Text + "&InvoiceWiseItmPurchaseReturnToDate=" + txtToDate.Text + "&IvnDistributorID=" + DistID + "&IvnDivisionID=" + ddlDivision.SelectedValue + "&IsDetail=" + IsDetail+ "&CompCust=" + CustomerId);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        string IsDetail = chkIsDetail.Checked ? "1" : "0";
        Decimal CustomerId = DistributorID > 0 ? DistributorID : DistID;
        ifmItemWiseInvoicePurchase.Attributes.Add("src", "../Reports/ViewReport.aspx?InvoiceWiseItmPurchaseReturnFromDate=" + txtFromDate.Text + "&InvoiceWiseItmPurchaseReturnToDate=" + txtToDate.Text + "&IvnDistributorID=" + DistID + "&IvnDivisionID=" + ddlDivision.SelectedValue + "&IsDetail=" + IsDetail + "&Export=1&CompCust=" + CustomerId);
    }
