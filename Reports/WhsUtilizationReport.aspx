<%@ Page Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="WhsUtilizationReport.aspx.cs" Inherits="Reports_WhsUtilizationReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="panel">
        <div class="panel-body">
            ...
            <iframe id="ifmWhs" style="width: 100%" class="embed-responsive-item" runat="server" onload="ifmWhs_Load"></iframe>
        </div>
    </div>
</asp:Content>
