<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="SpareConsuption.aspx.cs" Inherits="Reports_SpareConsuption" %>
            ...
            <div class="row _masterForm">
                <div class="col-lg-4">
                    <div class="input-group form-group divfromdate">
                        <asp:Label ID="lblFromDate" runat="server" Text="Task Comp. From Date" CssClass="lblFromDate input-group-addon"></asp:Label>
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group divtodate">
                        <asp:Label ID="lblToDate" runat="server" Text="Task Comp. To Date" CssClass="input-group-addon"></asp:Label>
                ...
                <div class="col-lg-4" id="div2" runat="server" style="display: none">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox ID="txtMechEmp" runat="server" CssClass="form-control txtMechEmp" Style="background-color: rgb(250, 255, 189);" TabIndex="9"></asp:TextBox>
