<%@ Page Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="VendorOutstandingRpt.aspx.cs" Inherits="Reports_VendorOutstandingRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="panel">
        <div class="panel-body">
            ...
            <iframe id="ifmVendorOutstanding" style="width: 100%" class="embed-responsive-item" runat="server" onload="ifmVendorOutstanding_Load"></iframe>
        </div>
    </div>
</asp:Content>
