<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="DistributorClaimStatusReport.aspx.cs" Inherits="Reports_DistributorClaimStatusReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Reload() {
            ...
            $(".onlyTomonth").on('focus blur click', function () {
                $(".ui-datepicker-calendar").hide();
            ...
            if ($('.gvclaimstatus thead tr').length > 0) {
                ...
                aryJSONColTable.push({ "width": "100px", "sClass": "dtbodyleft", "aTargets": 2 });
                ...
                aryJSONColTable.push({ "width": "20px", "sClass": "dtbodyRight", "aTargets": 5 });
                aryJSONColTable.push({ "width": "20px", "sClass": "dtbodyRight", "aTargets": 6 });
                aryJSONColTable.push({ "width": "20px", "sClass": "dtbodyRight", "aTargets": 7 });
                ...
                $('.gvclaimstatus').DataTable(
                    {
                        ...
                        },
                        {
                            ...
                            customize: function (xlsx) {
                                ...
                                var r6 = Addrow(7, [{ key: 'A', value: '' }, { key: 'B', value: '' }]);
                                if ($('.ddlReportBy option:selected').val() == '2') {
                                ...
                                var r10 = Addrow(11, [{ key: 'A', value: ' ' }, { key: 'B', value: '' }]);
                                ...
                                sheet.childNodes[0].childNodes[1].innerHTML = r0 + r2 + r3 + r4 + r5 + r7 + r8 + r9 + r11 + r12 + sheet.childNodes[0].childNodes[1].innerHTML;
                            }
                        },
                        {
                            extend: 'pdfHtml5',
                            ...
                            title: 'Distributor  / SS Claim Status Report',
                            footer: 'true',
                            exportOptions: {
                                columns: ':visible',
                                search: 'applied',
                            ...
                            customize: function (doc) {
                                ...
                                doc['content']['0'].table.widths = ['2%', '6%', '13%', '32%', '21%', '5%', '5%', '5%', '9%'];
                        ...
                        "footerCallback": function (row, data, start, end, display) {
                            ...
                            col5 = api.column(5, { page: 'current' }).data().reduce(function (a, b) {
                                return intVal(a) + intVal(b);
                            }, 0);
                            col6 = api.column(6, { page: 'current' }).data().reduce(function (a, b) {
                                return intVal(a) + intVal(b);
                            }, 0);
                            col7 = api.column(7, { page: 'current' }).data().reduce(function (a, b) {
                                return intVal(a) + intVal(b);
                            }, 0);
                            $(api.column(5).footer()).html(col5.toFixed(2));
                            $(api.column(6).footer()).html(col6.toFixed(2));
                            $(api.column(7).footer()).html(col7.toFixed(2));
                        }
                    });
    ...
    <div class="panel">
        <div class="panel-body">
            <div class="row _masterForm">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        <asp:Label ID="Label1" runat="server" Text="To Month" CssClass="input-group-addon"></asp:Label>
                        <asp:TextBox ID="txtToDate" TabIndex="1" runat="server" MaxLength="7"  CssClass="onlyTomonth form-control"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="input-group form-group">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox ID="txtRegion" CssClass="txtRegion form-control" OnChange="ClearDistributorSS()" TabIndex="6" runat="server" Style="background-color: rgb(250, 255, 189);"></asp:TextBox>
                ...
                <%-- <div class="col-lg-4">
                    <div class="input-group form-group">--%>
                <asp:Label ID="lblPlant" runat="server" Text='Plant' CssClass="input-group-addon" Visible="false"></asp:Label>
                <asp:TextBox ID="txtPlant" runat="server" Visible="false" Style="background-color: rgb(250, 255, 189);" TabIndex="7" CssClass="txtPlant form-control"></asp:TextBox>
                ...
                <%-- <div class="col-lg-4">
                    <div class="input-group form-group">--%>
                <asp:Label ID="lblstatus" runat="server" Visible="false" Text="Claim Status" CssClass="input-group-addon"></asp:Label>
                <asp:DropDownList runat="server" Visible="false" ID="ddlClaimStatus" TabIndex="9" CssClass="ddlClaimStatus form-control" Enabled="false">
                ...
                <%--  <div class="col-lg-4">
                    <div class="input-group form-group">--%>
                <asp:Label runat="server" ID="lblIsAuto" Text="Auto/Manual" CssClass="input-group-addon" Visible="false"></asp:Label>
                <asp:DropDownList runat="server" ID="ddlIsAuto" CssClass="ddlIsAuto form-control" TabIndex="10" Visible="false">
