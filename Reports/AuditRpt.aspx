<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="AuditRpt.aspx.cs" Inherits="Reports_Audit" %>
            ...
            <div class="row _masterForm">
                ...
                <div class="col-lg-4" id="div2" runat="server" style="display: none">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox ID="txtMechEmp" runat="server" CssClass="form-control txtMechEmp" Style="background-color: rgb(250, 255, 189);" TabIndex="6"></asp:TextBox>
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox ID="txtSerialNumber" CssClass="txtSerialNumber form-control" Style="background-color: rgb(250, 255, 189);" runat="server" TabIndex="9"></asp:TextBox>
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList ID="ddlStatus" runat="server" TabIndex="10" CssClass="ddlStatus form-control" DataTextField="TaskStatusName" DataValueField="TaskStatusID" AppendDataBoundItems="true">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4">
