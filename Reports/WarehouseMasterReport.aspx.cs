...
public partial class Reports_WarehouseMasterReport : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void ifmWarehouse_Load(object sender, EventArgs e)
    {
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmWarehouse.Attributes.Add("src", "../Reports/ViewReport.aspx?WarMstActive=" + Active + "&CompCust=" + CustomerID);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        decimal CustomerID = !String.IsNullOrEmpty(Cust) ? ctx.OCRDs.FirstOrDefault(x => x.CustomerCode == Cust && x.ParentID == ParentID).CustomerID : 0;
        string Active = chkIsActive.Checked ? "1" : "0";
        ifmWarehouse.Attributes.Add("src", "../Reports/ViewReport.aspx?WarMstActive=" + Active + "&CompCust=" + CustomerID + "&Export=1");
