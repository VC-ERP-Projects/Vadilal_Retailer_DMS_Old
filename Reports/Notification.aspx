<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Notification.aspx.cs" Inherits="Reports_Notification" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ReadAllNoti() {
            ...
            $.ajax({
                type: "POST",
                url: "Notification.aspx/ReadAllReminder",
                data: '',
        ...
        function DeleteAllNoti() {
            ...
            $.ajax({
                type: "POST",
                url: "Notification.aspx/DeleteAllReminder",
                data: '',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function DeleteNoti(Id) {
            ...
            $.ajax({
                type: "POST",
                url: "Notification.aspx/DeleteReminder",
                data: '{GCM1ID: ' + Id + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function ReadNoti(Id) {
            ...
            $.ajax({
                type: "POST",
                url: "Notification.aspx/ReadReminder",
                data: '{GCM1ID: ' + Id + '}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
        ...
        function Load() {
            ...
            $.ajax({
                url: 'Notification.aspx/GetTableData',
                type: 'POST',
                contentType: "application/json; charset=utf-8",
                data: "{}",
                dataType: "json",
