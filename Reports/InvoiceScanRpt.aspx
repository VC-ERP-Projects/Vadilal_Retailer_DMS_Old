<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="InvoiceScanRpt.aspx.cs" Inherits="Reports_InvoiceScanRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="Server">
    <div class="panel">
        <div class="panel-body">
            <div class="row _masterForm">
                ...
                <div class="col-lg-4 divDealer" id="divDealer" runat="server">
                    <div class="input-group form-group">
                        <asp:Label ID="lbldealer" runat="server" Text="Scan Dealer" CssClass="input-group-addon"></asp:Label>
        ...
        <div class="embed-responsive embed-responsive-16by9">
            <iframe id="ifmInvScan" style="height: 500px" class="embed-responsive-item" runat="server" onload="ifmInvScan_Load"></iframe>
        </div>
    </div>
</asp:Content>
