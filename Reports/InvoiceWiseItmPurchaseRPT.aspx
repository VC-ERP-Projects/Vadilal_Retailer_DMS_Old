<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="InvoiceWiseItmPurchaseRPT.aspx.cs" Inherits="Reports_InvoiceWiseItmPurchaseRPT" %>
            ...
            <div class="row _masterForm">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList ID="ddlDateOption" runat="server" TabIndex="7" CssClass="ddlDateOption form-control">
