...
public partial class Reports_ExpenseRequest : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmExpenseReq.Attributes.Add("src", "../Reports/ViewReport.aspx?ExpenseRequestFromDate=" + txtFromDate.Text + "&ExpenseRequestToDate=" + txtToDate.Text + "&ExpenseRqstEmpID=" + EmpID + "&ExpenseRqstManagerID=" + Manager + "&ExpenseRqstStatusID=" + ddlStatus.SelectedValue + "&ExpenseTypeID=" + ddlExpenseType.SelectedValue + "&ExpenseModeID=" + ddlExpenseMode.SelectedValue + "&IsDetail=" + IsDetail);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        int Manager = Int32.TryParse(txtManager.Text.Split("-".ToArray()).Last().Trim(), out Manager) ? Manager : 0;
        string IsDetail = chkIsDetail.Checked ? "1" : "0";
        ifmExpenseReq.Attributes.Add("src", "../Reports/ViewReport.aspx?ExpenseRequestFromDate=" + txtFromDate.Text + "&ExpenseRequestToDate=" + txtToDate.Text + "&ExpenseRqstEmpID=" + EmpID + "&ExpenseRqstManagerID=" + Manager + "&ExpenseRqstStatusID=" + ddlStatus.SelectedValue + "&ExpenseTypeID=" + ddlExpenseType.SelectedValue + "&ExpenseModeID=" + ddlExpenseMode.SelectedValue + "&IsDetail=" + IsDetail + "&Export=1");

    }

    protected void ifmExpenseReq_Load(object sender, EventArgs e)
    {
