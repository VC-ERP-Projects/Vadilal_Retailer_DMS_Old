...
public partial class Reports_DateWiseSalePurchaseSummary : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddltype.SelectedValue == "Q")
                Cm.CommandText = "GetDateWiseSalePurQty";
            else
            {
                Cm.CommandText = "GetDateWiseSalePurAmt";
                Cm.Parameters.AddWithValue("@WithVAT", ddlInvoicetype.SelectedValue);
            }
            ...
            if (CustType == 1)
            {
                ...
                Cm.Parameters.AddWithValue("@ParentID", DistributorID.ToString());
