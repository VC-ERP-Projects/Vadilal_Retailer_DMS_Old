...
public partial class Reports_CustomerMasterReport : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmCustomer.Attributes.Add("src", "../Reports/ViewReport.aspx?CustMstActive=" + Active + "&CompCust=" + CustomerID);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        decimal CustomerID = !String.IsNullOrEmpty(Cust) ? ctx.OCRDs.FirstOrDefault(x => x.CustomerCode == Cust && x.ParentID == ParentID).CustomerID : 0;
        string Active = chkIsActive.Checked ? "1" : "0";
        ifmCustomer.Attributes.Add("src", "../Reports/ViewReport.aspx?CustMstActive=" + Active + "&CompCust=" + CustomerID + "&Export=1");
