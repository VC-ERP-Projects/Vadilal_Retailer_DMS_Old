<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="PMCompletion.aspx.cs" Inherits="Reports_PMCompletion" %>
            ...
            <div class="row _masterForm">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList runat="server" ID="ddlMachineType" TabIndex="7" CssClass="ddlMachineType form-control" DataTextField="MachineTypeName" DataValueField="MachineTypeID">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox ID="txtSerialNumber" Style="background-color: rgb(250, 255, 189);" CssClass="txtSerialNumber form-control" runat="server" TabIndex="7"></asp:TextBox>
                        <asp:AutoCompleteExtender OnClientShown="resetPosition" CompletionListCssClass="CompletionListClass" ID="acettxtSerialNumber" runat="server" ServicePath="../Service.asmx" OnClientPopulating="acettxtSerialNo_OnClientPopulating"
                            UseContextKey="true" ServiceMethod="GetTypeWiseAssetSerialNo" MinimumPrefixLength="1" CompletionInterval="10" EnableCaching="false" CompletionSetCount="1" TargetControlID="txtSerialNumber">
                        </asp:AutoCompleteExtender>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        <asp:Button ID="btnGenerat" runat="server" Text="Export-Data" TabIndex="10" CssClass="btnGenerat btn btn-default" OnClick="btnGenerat_Click" />
                    </div>
                </div>
            </div>
        </div>
