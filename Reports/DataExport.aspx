<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="DataExport.aspx.cs" Inherits="Reports_DataExport" %>
    ...
    <div class="panel panel-default">
        <div class="panel-body _masterForm">
            <div class="row" style="margin-bottom: 0px">
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList ID="ddlType" runat="server" TabIndex="10" CssClass="ddlType form-control">
                            ...
                            <asp:ListItem Value="3"> Sale & Sale Return </asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4" style="display: none;" id="divPlant" runat="server">
                    <div class="input-group form-group">
                ...
                <div class="col-lg-4" runat="server" visible="false">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList runat="server" TabIndex="12" ID="ddlPurFrom" CssClass="ddlPurFrom form-control">
                            <asp:ListItem Text="Plant To Distributor" Value="1" Selected="True" />
                            <asp:ListItem Text="SuperStockist To Distributor" Value="2" />
                            <asp:ListItem Text="Plant To SuperStockist" Value="3" />
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4" runat="server" visible="false">
