...
public partial class Reports_ClientFeedBack : System.Web.UI.Page
{
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmMatStatus.Attributes.Add("src", "../Reports/ViewReport.aspx?CliFeedbackFromDate=" + txtFromDate.Text + "&CliFeedbackToDate=" + txtToDate.Text + "&CompCust=" + CustomerID);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        var Cust = txtCustCode.Text.Split("-".ToArray()).First().Trim();
        decimal CustomerID = !String.IsNullOrEmpty(Cust) ? ctx.OCRDs.FirstOrDefault(x => x.CustomerCode == Cust && x.ParentID == ParentID).CustomerID : 0;
        ifmMatStatus.Attributes.Add("src", "../Reports/ViewReport.aspx?CliFeedbackFromDate=" + txtFromDate.Text + "&CliFeedbackToDate=" + txtToDate.Text + "&CompCust=" + CustomerID + "&Export=1");
    }
