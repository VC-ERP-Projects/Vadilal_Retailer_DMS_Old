...
public partial class Reports_Audit : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Cm.CommandText = "MECH_Audit_Report";

            Cm.Parameters.AddWithValue("@ParentID", ParentID);
            Cm.Parameters.AddWithValue("@EmpID", UserID);
            Cm.Parameters.AddWithValue("@SUserID", SUserID);
            Cm.Parameters.AddWithValue("@AssetTypeID", MachineType);
            Cm.Parameters.AddWithValue("@TaskCompFromDate", StartDate);
            Cm.Parameters.AddWithValue("@TaskCompToDate", EndDate);
            ...
            Cm.Parameters.AddWithValue("@TaskStatus", ddlStatus.SelectedValue);
            Cm.Parameters.AddWithValue("@AssetSerial", txtSerialNumber.Text);
            Response.Clear();
            ...
            writer.WriteLine("Audit Date From ," + StartDate + "," + "To ," + EndDate);
            ...
            writer.WriteLine("Status," + ddlStatus.SelectedItem.Text);
            ...
            Response.AddHeader("content-disposition", "attachment; filename=DataExport_Audit_Report" + "_" + DateTime.Now.ToString("ddMMyyyyhhmmss") + ".csv");
