...
public partial class Reports_201C : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        if (CustType == 1 && CustomerID == 0)
            ...
            ifmConsumeWasteMaterial.Attributes.Add("src", "../Reports/ViewReport.aspx?201CFromDate=" + txtFromDate.Text + "&201CToDate=" + txtToDate.Text + "&CompCust=" + CustomerID);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        if (CustType == 1 && CustomerID == 0)
            ...
            ifmConsumeWasteMaterial.Attributes.Add("src", "../Reports/ViewReport.aspx?201CFromDate=" + txtFromDate.Text + "&201CToDate=" + txtToDate.Text + "&CompCust=" + CustomerID + "&Export=1");
