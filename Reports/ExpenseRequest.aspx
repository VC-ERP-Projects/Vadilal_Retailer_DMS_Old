<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="ExpenseRequest.aspx.cs" Inherits="Reports_ExpenseRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <div class="panel">
        ...
        <div class="embed-responsive embed-responsive-16by9">
            <iframe id="ifmExpenseReq" style="height: 500px" class="embed-responsive-item" runat="server" onload="ifmExpenseReq_Load"></iframe>
        </div>
    </div>
</asp:Content>
