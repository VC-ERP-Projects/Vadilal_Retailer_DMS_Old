<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="TravelAdvRequest.aspx.cs" Inherits="Reports_TravelAdvRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" Runat="Server">
    <div class="panel">
            ...
            <div class="row _masterForm">
                <div class="col-lg-4">
                    ...
                    <div class="input-group form-group">
                     ...
                     <div class="input-group form-group">
                        <asp:Label Text="Expense Type" runat="server" CssClass="input-group-addon" />
                        <asp:DropDownList runat="server" ID="ddlExpenseType" CssClass="ddlExpenseType form-control" DataTextField="ExpType" DataValueField="ExpTypeID">
                        </asp:DropDownList>
                    </div>
                    <div class="input-group form-group">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="input-group form-group">
                        <asp:Label Text="Expense Mode" runat="server" CssClass="input-group-addon" />
                        <asp:DropDownList runat="server" ID="ddlExpenseMode" CssClass="ddlExpenseMode form-control" DataTextField="ExpMode" DataValueField="ExpModeID">
                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4">
        ...
        <div class="embed-responsive embed-responsive-16by9">
            <iframe id="ifmTrvlAdvReq" style="height: 500px" class="embed-responsive-item" runat="server" onload="ifmTrvlAdvReq_Load"></iframe>
        </div>
    </div>
</asp:Content>
