<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="SalesPurchaseReturn.aspx.cs" Inherits="Reports_SalesPurchaseReturn" %>
        ...
        <div class="panel-body">
            <div class="row _masterForm">
                <div class="col-lg-4">
                    ...
                    <div class="input-group form-group">
                        <asp:Label ID="lblIsCustomerWise" runat="server" Text="Customer Wise" CssClass="input-group-addon"></asp:Label>
                        <asp:CheckBox ID="chkCustomerWise" runat="server" CssClass="chkCustomerWise form-control" Checked="true" />
                    </div>
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:TextBox ID="txtToDate" runat="server" MaxLength="10" TabIndex="4" onkeyup="return ValidateDate(this);" CssClass="todate form-control"></asp:TextBox>
                    </div>
                    <div class="input-group form-group">
                        <asp:Label ID="lblItem" runat="server" Text="Item Name" CssClass="input-group-addon"></asp:Label>
                        <asp:TextBox ID="txtItemName" runat="server" CssClass="form-control" TabIndex="5" autocomplete="off"></asp:TextBox>
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList runat="server" ID="ddlType" TabIndex="6" CssClass="form-control">
                            ...
                            <asp:ListItem Value="1">SaleReturnAgainBill</asp:ListItem>
                            <%--<asp:ListItem Value="2">SaleReturnOther</asp:ListItem>--%>
                        </asp:DropDownList>
                    </div>
                    <div class="input-group form-group">
            ...
            <iframe id="ifmSalesPurchaseReturn" style="width: 100%" class="embed-responsive-item" runat="server" onload="ifmSalesPurchaseReturn_Load"></iframe>
        </div>
    </div>
</asp:Content>
