...
public partial class Reports_SpareConsuption : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Cm.CommandText = "MECH_SpareConsumption_Report";
            ...
            Cm.Parameters.AddWithValue("@SerialNo", txtAssetSerialNo.Text);
            ...
            writer.WriteLine("Spare Consumption Report");
            ...
            Response.AddHeader("content-disposition", "attachment; filename=DataExport_Spare_Consumption_Report" + "_" + DateTime.Now.ToString("ddMMyyyyhhmmss") + ".csv");
