...
public partial class Reports_201A : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddlTaxType.DataSource = EnumList.Of<SalesType>().ToList();
            ddlTaxType.DataBind();

            ddlTaxType.Items.Insert(0, new ListItem("---- All ----", "0"));
        }
    }
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        if (CustType == 1 && CustomerID == 0)
            ...
            ifmConsumeWasteMaterial.Attributes.Add("src", "../Reports/ViewReport.aspx?201AFromDate=" + txtFromDate.Text + "&201AToDate=" + txtToDate.Text + "&201AReportType=" + ReportType.ToString() + "&201ATaxType=" + ddlTaxType.SelectedValue.ToString() + "&CompCust=" + CustomerID);
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        if (CustType == 1 && CustomerID == 0)
            ...
            ifmConsumeWasteMaterial.Attributes.Add("src", "../Reports/ViewReport.aspx?201AFromDate=" + txtFromDate.Text + "&201AToDate=" + txtToDate.Text + "&201AReportType=" + ReportType.ToString() + "&201ATaxType=" + ddlTaxType.SelectedValue.ToString() + "&CompCust=" + CustomerID + "&Export=1");
