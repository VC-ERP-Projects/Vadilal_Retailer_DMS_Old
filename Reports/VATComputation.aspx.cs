...
public partial class VATComputation : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmVATComm.Attributes.Add("src", "../Reports/ViewReport.aspx?VATCommFromDate=" + txtFromDate.Text + "&VATCommToDate=" + txtToDate.Text + "&CompCust=" + CustomerID);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        var Cust = txtCustCode.Text.Split("-".ToArray()).First().Trim();
        decimal CustomerID = !String.IsNullOrEmpty(Cust) ? ctx.OCRDs.FirstOrDefault(x => x.CustomerCode == Cust).CustomerID : 0;
        ifmVATComm.Attributes.Add("src", "../Reports/ViewReport.aspx?VATCommFromDate=" + txtFromDate.Text + "&VATCommToDate=" + txtToDate.Text + "&CompCust=" + CustomerID + "&Export=1");

    }

    #endregion

    protected void ifmVATComm_Load(object sender, EventArgs e)
    {
