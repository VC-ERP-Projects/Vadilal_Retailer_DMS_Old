...
public partial class Reports_GSTCompRpt : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnGenerat_Click(object sender, EventArgs e)
    {
        ...
        ifmBeatSummary.Attributes.Add("src", "../Reports/ViewReport.aspx?GSTDMSStatus=" + ddlDMSStatus.SelectedValue + "&Status=" + ddlMatchingStatus.SelectedValue +
            "&ReportBy=" + ddlDistSel.SelectedValue + "&SUserID=" + SUserID + "&DistID=" + DistributorID + "&SSID=" + SSID);
    }
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        ...
        ifmBeatSummary.Attributes.Add("src", "../Reports/ViewReport.aspx?GSTDMSStatus=" + ddlDMSStatus.SelectedValue + "&Status=" + ddlMatchingStatus.SelectedValue +
            "&ReportBy=" + ddlDistSel.SelectedValue + "&SUserID=" + SUserID + "&DistID=" + DistributorID + "&SSID=" + SSID + "&Export=1");
    }
