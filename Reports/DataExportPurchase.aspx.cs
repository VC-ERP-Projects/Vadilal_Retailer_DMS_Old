...
public partial class Reports_DataExportPurchase : System.Web.UI.Page
{
    #region Declaration
    ...
    protected void btnDetailData_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlReportBy.SelectedValue == "2")
                writer.WriteLine("Purchase From ," + ddlPurFrom.SelectedItem.Text);
            ...
            if (ddlReportBy.SelectedValue == "4" || (ddlReportBy.SelectedValue == "2" && ddlPurFrom.SelectedValue == "2"))
            ...
            if (ddlReportBy.SelectedValue == "4" || (ddlReportBy.SelectedValue == "2" && (ddlPurFrom.SelectedValue == "1" || ddlPurFrom.SelectedValue == "3")))
                writer.WriteLine("Invoice Plant ," + (InvPlant != 0 ? txtInvPlant.Text.Split('-')[0].ToString() + "," + txtInvPlant.Text.Split('-')[1].ToString() : "All Invoice Plant"));
            ...
            Response.AddHeader("content-disposition", "attachment; filename=" + ddlType.SelectedItem.Text + "_DataExport_" + DateTime.Now.ToString("ddMMyyyyhhmmss") + ".csv");
