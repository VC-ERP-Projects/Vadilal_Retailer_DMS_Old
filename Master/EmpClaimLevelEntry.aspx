<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="EmpClaimLevelEntry.aspx.cs" Inherits="Master_EmpClaimLevelEntry" %>
       ...
       // var LogoURL = '../Images/LOGO.png';
        ...
        $(document).ready(function () {
            ...
            $(document).on('keyup', '.AutoRegion', function () {
                ...
                $('#AutoRegion' + col1).autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            type: "POST",
                            url: 'EmpClaimLevelEntry.aspx/SearchRegion',
                            dataType: "json",
            ...
            $('.AutoRegion').on('blur', function (e, ui) {
                ...
                if ($('#AutoRegion' + col1).val() != "") {
                    ...
                    CheckDuplicateData($('#AutoRegion' + col1).val().trim(), $('#AutoEmpName' + col1).val().trim(), $('#AutoDist' + col1).val().trim(), $('#AutoSS' + col1).val().trim(), col1, 1);
                }
            });
            ...
            $('.AutoEmpName').on('blur', function (e, ui) {
                ...
                if ($('#AutoEmpName' + col1).val() != "") {
                    ...
                    CheckDuplicateData($('#AutoRegion' + col1).val().trim(), $('#AutoEmpName' + col1).val().trim(), $('#AutoDist' + col1).val().trim(), $('#AutoSS' + col1).val().trim(), col1, 2);
            ...
            $(document).on('keyup', '.AutoDist', function () {
                ...
                $('#AutoDist' + col1).autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: 'EmpClaimLevelEntry.aspx/SearchDistributor',
                            dataType: "json",
            ...
            $(document).on('keyup', '.AutoSS', function () {
                var textValue = $(this).val();
                var txtId = $(this).attr("id");
                var col1 = txtId.replace("AutoSS", '');
                $('#AutoSS' + col1).autocomplete({
                    source: function (request, response) {
                        var EmpId = 0, RegionId = 0;
                        $.ajax({
                            type: "POST",
                            url: 'EmpClaimLevelEntry.aspx/SearchSuperStockiest',
                            dataType: "json",
                            data: "{ 'prefixText': '" + (textValue != '' ? textValue : '*') + "','strEmpId':'" + EmpId + "','strRegionId':'" + RegionId + "'}",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
            ...
            $('.AutoSS').on('blur', function (e, ui) {
                ...
                if ($('#AutoSS' + col1).val().trim() != "") {
                    ...
                    CheckDuplicateData($('#AutoRegion' + col1).val().trim(), $('#AutoEmpName' + col1).val().trim(), $('#AutoDist' + col1).val().trim(), $('#AutoSS' + col1).val().trim(), col1, 4);
                }
            });


            //  $("#tblEmpClaimLevel").tableHeadFixer('70vh');
            //  $("#gvEmpClaimLevelHistory").tableHeadFixer('75vh');
        ...
        function CheckDuplicateData(pRegioCode, pEmpCode, pDistCode, pSSCode, row, ChkType) {
            ...
            $('#tblEmpClaimLevel  > tbody > tr').each(function (row1, tr) {
                ...
                var DistCode = $("input[name='AutoDist']", this).val() != "" ? $("input[name='AutoDist']", this).val().split("#")[2].trim() : "";
                var SSCode = $("input[name='AutoSS']", this).val() != "" ? $("input[name='AutoSS']", this).val().split("#")[2].trim() : "";
        ...
        function FillData() {
            ...
            var IsValid = true;
            $.ajax({
                url: 'EmpClaimLevelEntry.aspx/LoadData',
                type: 'POST',
                dataType: 'json',
                contentType: 'application/json; charset=utf-8',
                        ...
                        if (items.length > 0) {
                            ...
                            for (var i = 0; i < items.length; i++) {
                                ...
                                strEmp = "<tr id='trUserMap" + indE + "'>"
                                    ...
                                    + "<td class='tdRegion'><input type='text' id='AutoRegion" + indE + "' name='AutoRegion' onchange='ChangeData(this);' class='form-control search AutoRegion ' value='" + items[i].Region + "' disabled='false' /></td>"
                                    + "<td class='tdUser'><input type='text' id='AutoEmpName" + indE + "' name='AutoEmpName' onchange='ChangeData(this);' class='form-control search AutoEmpName' value='" + items[i].EmployeeName + "' disabled='false' /></td>"
                                    ...
                                    + "<td class='tdss'><input type='text' id='AutoSS" + indE + "' name='AutoSS' onchange='ChangeData(this);' class='form-control search AutoSS' value='" + items[i].DistName + "' disabled='false' /></td>"
                                    ...
                                    + "<td class='dtbodyRight'><input type='text' id='txtLevel" + indE + "' name='txtLevel' onchange='ChangeData(this);' maxlength='3' onkeypress='return isNumber(event)' class='form-control txtLevel' value='" + items[i].ClaimLevel + "'  disabled='false'/></td>"
                                    ...
                                    + "<input type='hidden' class='hdnDistId' id='hdnDistId" + indE + "' name='hdnDistId' value='" + items[i].CustomerId + "'/></td>"
                                    ...
                                    + "<input type='hidden' class='hdnSSID' id='hdnSSID" + indE + "' name='hdnSSID' value='" + items[i].CustomerId + "'/></td>"
                                    + "<input type='hidden' class='hdnOCLEID' id='hdnOCLEID" + indE + "' name='hdnOCLEID' value='" + items[i].OCLEID + "' /></td>"
                                ...
                                //  ShowDistOrSS();
                                $('#trUserMap' + indE).find('#chkIsHeirchy' + indE).prop("checked", items[i].IsHeirarchy);
                                ...
                                $('#txtLevel' + indE).on('change keyup', function () {
                                    var currentRow = $(this).closest("tr");
                                    var col1 = currentRow.find("td:eq(0)").text();
                                    if ($('#txtLevel' + col1).val() == "") {
                                        ClearClaimRow(col1);
                                    }
                                });
                                $('#txtLevel' + indE).on('blur', function (e, ui) {
                                    if ($('#txtLevel' + indE).val().trim() != "") {
                                        var currentRow = $(this).closest("tr");
                                        var col1 = currentRow.find("td:eq(0)").text();

                                        if ($('#txtLevel' + col1).val() == "") {
                                            ModelMsg("Select Enter Level", 3);
                                            $('#txtLevel' + col1).val("");
                                            return false;
                                        }
                                        var txt = $('#txtLevel' + col1).val();
                                        if (txt == "undefined" || txt == "") {
                                            //ModelMsg("Enter Item Code Or Name", 3);
                                            return false;
                                        }
                                        ...
                                        //var option = $(".ddlOption").val();
                                        //if (option == 1) {
                                        //    CheckDuplicateData("", $('#AutoDist' + col1).val(), col1, 4, "", $('#txtLevel' + col1).val());
                                        //}
                                        //else {
                                        //    CheckDuplicateData("", "", col1, 4, $('#AutoSS' + col1).val(), $('#txtLevel' + col1).val());
                                        //}
        ...
        function ClearControls() {
            ...
            if ($('.chkIsReport').find('input').is(':checked')) {
                ...
                aryJSONColTable.push({ "width": "200px", "sClass": "dtbodyLeft", "aTargets": 5 });
                aryJSONColTable.push({ "width": "200px", "sClass": "dtbodyLeft", "aTargets": 6 });
                aryJSONColTable.push({ "width": "35px", "sClass": "dtbodyCenter", "aTargets": 7 });
                aryJSONColTable.push({ "width": "40px", "sClass": "dtbodyCenter", "aTargets": 8 });
                aryJSONColTable.push({ "width": "60px", "sClass": "dtbodyCenter", "aTargets": 9 });
                aryJSONColTable.push({ "width": "140px", "sClass": "dtbodyLeft", "aTargets": 10 });
        ...
        function AddMoreRow() {
            ...
            strEmp = "<tr id='trUserMap" + indE + "'>"
                ...
                + "<td class='dtbodyRight'><input type='text' id='txtLevel" + indE + "' name='txtLevel' onchange='ChangeData(this);' maxlength='3' onkeypress='return isNumber(event)' class='form-control txtLevel'/></td>"
            ...
            $('#AutoRegion' + indE).on('blur', function (e, ui) {
                ...
                if ($('#AutoRegion' + indE).val().trim() != "") {
                    ...
                    CheckDuplicateData($('#AutoRegion' + indE).val().trim(), $('#AutoEmpName' + indE).val().trim(), $('#AutoDist' + indE).val().trim(), $('#AutoSS' + indE).val().trim(), indE, 1);
                }
            });
            ...
            $('#AutoEmpName' + indE).on('blur', function (e, ui) {
                if ($('#AutoEmpName' + indE).val().trim() != "") {
                    ...
                    CheckDuplicateData($('#AutoRegion' + indE).val().trim(), $('#AutoEmpName' + indE).val().trim(), $('#AutoDist' + indE).val().trim(), $('#AutoSS' + indE).val().trim(), indE, 2);
                }
            });
            ...
            $('#AutoSS' + indE).on('blur', function (e, ui) {
                if ($('#AutoSS' + indE).val().trim() != "") {
                    ...
                    CheckDuplicateData($('#AutoRegion' + indE).val().trim(), $('#AutoEmpName' + indE).val().trim(), $('#AutoDist' + indE).val().trim(), $('#AutoSS' + indE).val().trim(), indE, 4);
                }
            });
            //End Distributor textbox
            ...
            //        //var option = $(".ddlOption").val();
            //        //if (option == 1) {
            //        //    CheckDuplicateData($('#AutoEmpName' + col1).val(), "", col1, 4, "", $('#txtLevel' + col1).val());
            //        //}
            //        //else if (option == 2) {
            //        //    CheckDuplicateData("", $('#AutoDist' + col1).val(), col1, 4, "", $('#txtLevel' + col1).val());
            //        //}
        ...
        function Cancel() {
            window.location = "../Master/EmpClaimLevelEntry.aspx";
        }
        ...
        function btnSubmit_Click() {
            ...
            var option = $(".ddlOption").val();
            $('#tblEmpClaimLevel  > tbody > tr').each(function (row, tr) {
                var ClaimLevel = $("input[name='txtLevel']", this).val();
                var IsHeirachy = $("input[name='chkIsHeirchy']", this).is(':checked');
                var IsChange = $("input[name='IsChange']", this).val().trim();
                if (IsHeirachy == true && ClaimLevel < 0 && IsChange == "1" ) {
                    $.unblockUI();
                    IsValid = false;

                    ModelMsg("Please enter Level : " + (parseInt(row) + 1), 3);
                    return false;
                }
                if (ClaimLevel > 0 && IsHeirachy == false && IsChange == "1" ) {
                    $.unblockUI();
                    IsValid = false;
                    ModelMsg("Please select Heirachy required : " + (parseInt(row) + 1), 3);
                    return false;
                }
            });
            $('#tblEmpClaimLevel  > tbody > tr').each(function (row, tr) {
                var EmpName = "", ClaimLevel = 0;
                EmpName = $("input[name='AutoEmpName']", this).val().split('#').pop().trim();
                var Region = $("input[name='AutoRegion']", this).val().split('-').pop().trim();
                var ClaimLevel = $("input[name='txtLevel']", this).val();
                var IsHeirachy = $("input[name='chkIsHeirchy']", this).is(':checked');
                if (option == 1) {
                    Dist = $("input[name='AutoDist']", this).val().split('#').pop().trim();

                    var IsDeleted = $('#hdnIsRowDeleted').val();
                    var IsChange = $("input[name='IsChange']", this).val().trim();

                    //if (EmpName != "" && Region != "" && Dist != "" && ClaimLevel != "") {
                    //    $.unblockUI();
                    //    ModelMsg("Please select at least one parameter : " + (parseInt(row) + 1), 3);
                    //    return false;
                    //}
                    if ((EmpName != "" || Region != "" || Dist != "") && (IsChange == "1" || IsDeleted == 1)) {
                        totalItemcnt = 1;
                ...
                if (option == 2) {
                    ...
                    var IsDeleted = $('#hdnIsRowDeleted').val();
                    var IsChange = $("input[name='IsChange']", this).val().trim();
                    var SSName = $("input[name='AutoSS']", this).val().split('#').pop().trim();

                    //if (EmpName != "" && Region != "" && SSName != "" && ClaimLevel != "") {
                    //    $.unblockUI();
                    //    ModelMsg("Please select at least one parameter : " + (parseInt(row) + 1), 3);
                    //    return false;
                    //}
                    if ((EmpName != "" || Region != "" || SSName != "") && (IsChange == "1" || IsDeleted == 1)) {
                        totalItemcnt = 1;
                        var OCLEID = $("input[name='hdnOCLEID']", this).val().trim();
                        var EmpId = $("input[name='hdnEmpId']", this).val().trim();
                        var RegionId = $("input[name='hdnRegionId']", this).val().trim();
                        var DistId = $("input[name='hdnSSID']", this).val().trim();
                        var IsActive = $("input[name='chkIsActive']", this).is(':checked');
                        var IsHeirachy = $("input[name='chkIsHeirchy']", this).is(':checked');
                        var IsChange = $("input[name='IsChange']", this).val().trim();
                        if (RegionId == 0 && DistId == 0 && EmpId == 0) {
                        }
                        else {
                            var obj = {
                                OCLEID: OCLEID,
            ...
            if (IsValid) {
                var sv = $.ajax({
                    url: 'EmpClaimLevelEntry.aspx/SaveData',
                    type: 'POST',
                    //async: false,
                    dataType: 'json',
                    // traditional: true,
        ...
        function ShowDistOrSSOnChange() {
            ...
            if (option == 1) {
                //  $('#tblEmpClaimLevel').find('th:nth-child(5)').show();
                //   $('#tblEmpClaimLevel').find('th:nth-child(6)').hide();
                //$('#tblEmpClaimLevel').find('th:nth-child(8)').hide();
                $('.tdDist').show();
                $('.thDist').show();
                ClearClaimRow();
                //  $('#tblEmpClaimLevel').find('th:nth-child(3)').show();
                $('.tdss').hide();
                $('.thss').hide();
            }
            else if (option == 2) {
                //   $('#tblEmpClaimLevel').find('th:nth-child(5)').hide();
                $('.tdDist').hide();
                $('.thDist').hide();
                //    $('#tblEmpClaimLevel').find('th:nth-child(6)').show();
                $('.tdss').show();
                $('.thss').show();
                ClearClaimRow();
                //    $('#tblEmpClaimLevel').find('th:nth-child(5)').show();
                //   $('#tblEmpClaimLevel').find('th:nth-child(8)').show();
        ...
        function GetReport() {
            ...
            if ($('.chkIsReport').find('input').is(':checked')) {
                ...
                $('.gvEmpClaimLevelHistory tbody').empty();
                $.ajax({
                    url: 'EmpClaimLevelEntry.aspx/LoadReport',
                    type: 'POST',
                    dataType: 'json',
                    async: false,
                    contentType: 'application/json; charset=utf-8',
                        ...
                        if (result.d[0] == "" || result.d[0] == undefined) {
                            ...
                            for (var i = 0; i < ReportData.length; i++) {
                                ...
                                str = "<tr><td>" + k + "</td>"
                                    ...
                                    + "<td class='tdDist'>" + ReportData[i].CustomerName + "</td>"
                                    + "<td class='tdss'>" + ReportData[i].CustomerName + "</td>"
                                    + "<td>" + ReportData[i].IsHeirarchy + "</td>"
                                    + "<td>" + ReportData[i].ClaimLevel + "</td>"
                        ...
                        <table id="tblEmpClaimLevel" class="table table-bordered nowrap" border="1" tabindex="8" style="border-collapse: collapse; font-size: 10px;">
                            <thead>
                                <tr class="table-header-gradient">
                                    ...
                                    <th style="width: 20%; padding-left: 10px !important;" class="thDist">Distributor</th>
                                    <th style="width: 20%; padding-left: 10px !important;" class="thss">Super Stockiest</th>
                                    <th style="width: 3%;">Hie Req?</th>
                                    <th style="width: 20%; padding-left: 10px !important;">Level</th>
                        ...
                        <table id="gvEmpClaimLevelHistory" class="gvEmpClaimLevelHistory table table-bordered nowrap" style="width: 100%; font-size: 10px;">
                            <thead>
                                <tr class="table-header-gradient">
                                    ...
                                    <th style="width: 10%" class="thDist">Distributor</th>
                                    <th style="width: 10%" class="thss">Super Stockiest</th>
                                    <th style="width: 3%;">Hie Req?</th>
