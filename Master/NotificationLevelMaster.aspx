<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="NotificationLevelMaster.aspx.cs" Inherits="Master_NotificationLevelMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function FillData() {
            $.ajax({
                url: 'NotificationLevelMaster.aspx/LoadData',
                type: 'POST',
                dataType: 'json',
                async: false,
    ...
    function FillOrder() {
        ...
        $.ajax({
            url: 'NotificationLevelMaster.aspx/GetDetail',
            type: 'POST',
            dataType: 'json',
            async: false,
            contentType: 'application/json; charset=utf-8',
            ...
            success: function (result) {
                if (result == "") {
                    ...
                    for (var i = 0; i < result.d[0].length; i++) {
                        ...
                        $('#chckIsCustomer' + cnt).prop('checked', result.d[0][i].IsCustomer);
                        cnt++;
                    }
                }
            },
    ...
    function btnSubmit_Click(print) {
        ...
        $('#tblLevelDetail  > tbody > tr').each(function (row, tr) {
            ...
            var IsCustomer = $("input[name='chckIsCustomer']", this).is(':checked');
        ...
        if (successMSG == false) {
            ...
            var successMSG = true;
            var sv = $.ajax({
                url: 'NotificationLevelMaster.aspx/SaveData',
                type: 'POST',
                dataType: 'json',
    ...
    function AddMoreRowMaterial() {
        ...
        str = "<tr id='trMaterial" + ind + "'>"
            ...
            + "<td><input type='checkbox' id='chckIsCustomer" + ind + "' name='chckIsCustomer'class='form-control'/></td>"
        ...
        <div class="panel-body _masterForm">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:DropDownList ID="ddlRequestType" class="ddlRequestType" runat="server" CssClass="ddlRequestType form-control" onchange="FillOrder();">
                            ...
                            <asp:ListItem Text="Off Beat" Value="9111"></asp:ListItem>
                            <asp:ListItem Text="Day End" Value="9101"></asp:ListItem>
                            <asp:ListItem Text="Sales Order" Value="9104"></asp:ListItem>
                            <asp:ListItem Text="Add New Customer" Value="9106"></asp:ListItem>
                            <asp:ListItem Text="Asset Request" Value="9112"></asp:ListItem>
                            <asp:ListItem Text="Asset Approve" Value="9129"></asp:ListItem>
                            <asp:ListItem Text="Leave Application" Value="9114"></asp:ListItem>
                            <asp:ListItem Text="Leave Approval" Value="9115"></asp:ListItem>
                            <asp:ListItem Text="Expense Request" Value="9120"></asp:ListItem>
                            <asp:ListItem Text="Expense Approve" Value="9123"></asp:ListItem>
                            <asp:ListItem Text="Travel Request" Value="9121"></asp:ListItem>
                            <asp:ListItem Text="Travel Approve" Value="9122"></asp:ListItem>
                            <asp:ListItem Text="Master Discount Request" Value="9141"></asp:ListItem>
                            <asp:ListItem Text="Master Discount Approve" Value="9142"></asp:ListItem>
                            <asp:ListItem Text="Preventive Maintainence Task" Value="5001"></asp:ListItem>
                            <asp:ListItem Text="Audit Maintainence Task" Value="5002"></asp:ListItem>
                            <asp:ListItem Text="Task Complaint Registration" Value="5003"></asp:ListItem>
                ...
                <div class="col-lg-4" id="divEmpCode" runat="server">
                    <div class="input-group form-group">
                        <asp:Label ID="lblCode" runat="server" Text="Excluding Employee" CssClass="input-group-addon"></asp:Label>
                        <asp:TextBox ID="txtCode" runat="server" CssClass="form-control txtCode" TabIndex="3"></asp:TextBox>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="input-group form-group">
                ...
                <div class="col-lg-4">
                    <span style="color: red; font-size: smaller">Enter Comma separated Employee Codes</span>
                </div>
            </div>
                        ...
                        <table id="tblLevelDetail" class="table" border="1" tabindex="10">
                            <thead>
                                <tr class="table-header-gradient">
                                    ...
                                    <th style="width: 6%;">Is Customer</th>
