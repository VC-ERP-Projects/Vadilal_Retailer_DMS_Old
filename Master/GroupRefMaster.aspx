<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="GroupRefMaster.aspx.cs" Inherits="Master_GroupRefMaster" %>
                ...
                <div class="col-lg-12">
                    <asp:GridView runat="server" ID="gvCategory" CssClass="table gvCategory" ShowHeader="true" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="25px">
                                <ItemTemplate>
                                    <asp:Button Font-Size="11px" ID="btnEdit" runat="server" Text="Edit" CssClass="btn btn-default btnEditDelete" CommandName="EditMode" CommandArgument='<%#Eval("DiscountGroupId") %>'></asp:Button>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30px">
                                <ItemTemplate>
                                    <asp:LinkButton Font-Size="11px" ID="btnDelete" runat="server" CssClass="btn btn-default btnEditDelete" OnClientClick="return confirm('Are you sure you want to delete this category?');" CommandName="DeleteMode" CommandArgument='<%#Eval("DiscountGroupId") %>'>Delete </asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField HeaderText="Category" DataField="GroupName" HeaderStyle-Width="100px" ItemStyle-HorizontalAlign="Left"></asp:BoundField>
                            <asp:BoundField HeaderText="FromDate" DataField="FromDate" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30px"></asp:BoundField>
                            <asp:BoundField HeaderText="ToDate" DataField="ToDate" ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="30px"></asp:BoundField>
                            <asp:BoundField HeaderText="Active" DataField="Active" HeaderStyle-Width="22px" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField HeaderText="Created By" DataField="CreatedBy" HeaderStyle-Width="80px" HeaderStyle-HorizontalAlign="Left" />
                            <asp:BoundField HeaderText="Created Date" DataField="CreatedDate" DataFormatString="{0:dd-MMM-yy HH:mm}" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle CssClass="lblCenter" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="Updated By" DataField="UpdatedBy" HeaderStyle-Width="80px"  HeaderStyle-HorizontalAlign="Left"/>
                            <asp:BoundField HeaderText="Updated Date" DataField="UpdatedDate" DataFormatString="{0:dd-MMM-yy HH:mm}" HeaderStyle-Width="50px" ItemStyle-HorizontalAlign="Center">
                                <HeaderStyle CssClass="lblCenter" />
                            </asp:BoundField>
                        </Columns>
                    </asp:GridView>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">
                            <asp:Label ID="lblModalTitle" runat="server" Text="Group / Category Master"></asp:Label></h4>
                        <asp:HiddenField ID="hdnCategoryId" runat="server"></asp:HiddenField>
                    </div>
                    <div class="">
                        <div class="col-lg-12">
                            <div class="input-group form-group">
                                <asp:Label ID="Label1" runat="server" Text="Option" CssClass="input-group-addon"></asp:Label>
                        ...
                        <div class="col-lg-12">
                            <div class="input-group form-group">
                                <asp:Label ID="lblDiscription" runat="server" Text="From Date" CssClass="input-group-addon"></asp:Label>
                         ...
                         <div class="col-lg-12">
                            <div class="input-group form-group">
                                <asp:Label ID="Label2" runat="server" Text="To Date" CssClass="input-group-addon"></asp:Label>
