<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="SalesTeamHierarchyMaster.aspx.cs" Inherits="Master_SalesTeamHierarchyMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            aryJSONColTable.push({ "width": "100px", "sClass": "dtbodyLeft", "aTargets": 4 });
            aryJSONColTable.push({ "width": "20px", "sClass": "dtbodyCenter", "aTargets": 5 });
            aryJSONColTable.push({ "width": "20px", "sClass": "dtbodyCenter", "aTargets": 6 });
            aryJSONColTable.push({ "width": "20px", "sClass": "dtbodyCenter", "aTargets": 7 });
            aryJSONColTable.push({ "width": "20px", "sClass": "dtbodyCenter", "aTargets": 8 });
            aryJSONColTable.push({ "width": "65px", "sClass": "dtbodyLeft", "aTargets": 9 });//"sClass": "dtbodyLeft",
            aryJSONColTable.push({ "width": "45px", "sClass": "dtbodyCenter", "aTargets": 10 });
            aryJSONColTable.push({ "width": "45px", "sClass": "dtbodyLeft", "aTargets": 11 });
            aryJSONColTable.push({ "width": "45px", "sClass": "dtbodyCenter", "aTargets": 12 });
        ...
        function AddMoreRow() {
            ...
            str = "<tr id='trOSTM" + ind + "'>"
                ...
                + "<td class='tdRegion'><input type='text' id='AutoRegion" + ind + "' name='AutoRegion' onchange='ChangeData(this);' class='form-control search AutoRegion ' /></td>"
               ...
               /* + "<td><input type='text' id='AutoEmpName" + ind + "' name='AutoEmpName' onchange='ChangeData(this);' class='form-control search ' /></td>"*/
                ...
                + "<td class='dtbodyCenter'><input type='checkbox' id='chkmanual" + ind + "' name='chkmanual'  onchange='ChangeDataManual(this);' class='checkbox'/></td>"
                + "<td class='dtbodyCenter'><input type='checkbox' id='chkCamscanning" + ind + "' name='chkCamscanning' onchange='ChangeDataCamScanning(this);'  class='checkbox'/></td>"
                + "<td class='dtbodyCenter'><input type='checkbox' id='chkBoth" + ind + "' name='chkBoth' onchange='ChangeDataBoth(this);'  class='checkbox'/></td>"
                + "<td class='dtbodyCenter'><input type='checkbox' id='chkIsActive" + ind + "' name='chkIsActive' onchange='ChangeData(this);'  class='checkbox'/></td>"
                + "<td id='tdCreatedBy" + ind + "' class='tdCreatedBy CustName'></td>"
                + "<td id='tdCreatedDate" + ind + "' class='tdCreatedDate dtbodyCenter'></td>"
                + "<td id='tdUpdateBy" + ind + "' class='tdUpdateBy CustName'></td>"
                + "<td id='tdUpdateDate" + ind + "' class='tdUpdateDate dtbodyCenter'></td>"
            ...
            $('#AutoEmpGroup' + ind).autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'SalesTeamHierarchyMaster.aspx/SearchEmployeeGroup',
                        type: "POST",
                        dataType: "json",
            ...
            $('#AutoEmpGroup' + ind).on('blur', function (e, ui) {
                if ($('#AutoEmpGroup' + ind).val().trim() != "") {
                    ...
                    CheckDuplicateCustomer($('#AutoEmpGroup' + ind).val().trim(), $('#AutoEmpName' + ind).val().trim(), $('#AutoRegion' + ind).val().trim(), ind, 1);
            ...
            $('#AutoEmpName' + ind).autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'SalesTeamHierarchyMaster.aspx/SearchEmployee',
                        dataType: "json",
            ...
            $('#AutoEmpName' + ind).on('blur', function (e, ui) {
                ...
                var ind = txtId.replace("AutoEmpName", '');
                if ($('#AutoEmpName' + ind).val().trim() != "") {
                    ...
                    CheckDuplicateCustomer($('#AutoEmpGroup' + ind).val(), $('#AutoEmpName' + ind).val().trim(), $('#AutoRegion' + ind).val(), ind, 2);
                }
            });
            ...
            $('#AutoRegion' + ind).autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'SalesTeamHierarchyMaster.aspx/SearchRegion',
                        type: "POST",
                        dataType: "json",
                        data: "{ 'prefixText': '" + (request.term != '' ? request.term : '*') + "'}",
                        contentType: "application/json; charset=utf-8",
                ...
                select: function (event, ui) {
                    ...
                    $('#hdnRegionId' + ind).val(ui.item.value.split("-")[2]);
            ...
            $('#AutoRegion' + ind).on('blur', function (e, ui) {
                ...
                var txtId = $(this).attr("id");
                var ind = txtId.replace("AutoRegion", '');
                ...
                if ($('#AutoRegion' + ind).val().trim() != "") {
                    ...
                    CheckDuplicateCustomer($('#AutoEmpGroup' + ind).val(), $('#AutoEmpName' + ind).val().trim(), $('#AutoRegion' + ind).val(), ind, 3);
                }
            });
            ...
            $('#AutoCustName' + ind).autocomplete({
                source: function (request, response) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'SalesTeamHierarchyMaster.aspx/SearchCustomer',
                        dataType: "json",
            ...
            $('#AutoCustName' + ind).on('blur', function (e, ui) {
                if ($('#AutoCustName' + ind).val().trim() != "") {
                    ...
                    CheckDuplicateCustomer($('#AutoEmpGroup' + ind).val().trim(), $('#AutoEmpName' + ind).val().trim(), $('#AutoRegion' + ind).val().trim(), ind, 2);
                }
            });
        ...
        // End Region
        function CheckDuplicateCustomer(EmpGroupCode, pEmpCode, pRegioCode, row, ChkType) {
            debugger;
            var Item = "", RgnId = "", EmpCode = ""
            //if (pRegioCode != "") {
            //    Item = pRegioCode.split("-")[2].trim();
            //}
            var oldEmpGroupCode = EmpGroupCode;
            //if (EmpGroupCode != "") {
            //    Item = EmpGroupCode.split("#")[2];
            //}
            if (pRegioCode != "") {
                RgnId = pRegioCode.split("-")[2].trim();
            }
            if (pEmpCode != "") {
                EmpCode = pEmpCode.split("-")[2].trim();
            }
            ...
            $('#tblCustomer  > tbody > tr').each(function (row1, tr) {
                ...
                if (ChkType == 1) {
                    ...
                    if (EmpCode != "") {
                        if (parseInt(row) != parseInt(LineNum)) {
                            if (pEmpCode.split("-").pop().trim() == EmpCode) {
                                cnt = 1;
                                errRow = row;
                                $('#AutoEmpName' + row).val('');
                                // $('#AutoCustName' + row).val('');
                                errormsg = 'Employee is already set for = ' + pEmpCode + ' at row : ' + rowCnt_Customer;
                                return false;
                            }
                        }
                    }
                    ...
                    if (RgnId != "") {
                        if (parseInt(row) != parseInt(LineNum)) {
                            if (RgnId == RegionCode) {
                                ...
                                $('#AutoRegion' + ind).val("");
                                $('#hdnRegionId' + ind).val(0);
                                errormsg = 'Region is already set for = ' + pRegioCode + ' at row : ' + rowCnt_Customer;
                                return false;
                            }
                        }
                    }
        ...
        //function CheckDuplicateCustomer(EmpGroupCode, pRegioCode, pEmpCode, ItemCustomerId, row, ChkType) {
        //    var Item = "";
        //    if (pRegioCode != "") {
        //        Item = pRegioCode.split("-")[2].trim();
        //    }
        ...
        function FillData() {
            ...
            $.ajax({
                url: 'SalesTeamHierarchyMaster.aspx/LoadData',
                type: 'POST',
                dataType: 'json',
                contentType: 'application/json; charset=utf-8',
                data: JSON.stringify(),
                    ...
                    if (result.d[0].length == 0) {
                        ...
                        if (items.length > 0) {
                            ...
                            for (var i = 0; i < items.length; i++) {
                                ...
                                $('#hdnScanningTypeId' + row).val(items[i].OSTHMID);
        ...
        function GetReport() {
            ...
            if ($('.chkIsReport').find('input').is(':checked')) {
                ...
                $.ajax({
                    url: 'SalesTeamHierarchyMaster.aspx/LoadReport',
                    type: 'POST',
                    dataType: 'json',
                    async: false,
                    contentType: 'application/json; charset=utf-8',
        ...
        function Cancel() {
            window.location = "../Master/SalesTeamHierarchyMaster.aspx";
        }
        ...
        function btnSubmit_Click() {
            ...
            $('#tblCustomer  > tbody > tr').each(function (row, tr) {
                ...
                var EmpName = $("input[name='AutoEmpGroup']", this).val();
                ...
                var IschkMobile = $("input[name='chkmanual']", this).is(':checked');
                var IschkEmail = $("input[name='chkCamscanning']", this).is(':checked');
                var IsDeleted = $('#hdnIsRowDeleted').val();
                //if ($("input[name ='AutoRegion']", this).val() == "") {
                //    ModelMsg("Please select atleast one Item", 3);
                //    return false;
                //}
                if ((RegionId != "" || EmpGroupCode != "" || Region != "" || EmpName != "") && (IsChange == "1" || IsDeleted == 1)) {

                    if ((IschkMobile != false || IschkEmail != false)) {
                    }
                }
                if ((Region == "" || EmpGroupCode == "") && IsChange == "1") {
                    $.unblockUI();
                    IsValid = false;
                    ModelMsg("Please select atleast one Region : " + (parseInt(row) + 1), 3);
                    return false;
                }
            ...
            $('#tblCustomer  > tbody > tr').each(function (row, tr) {
                ...
                if ((RegionId != "" || Region != "" || EmpGroupCode!= "" || EmpName != "") && (IsChange == "1" || IsDeleted == 1)) {

                    //if ((IschkMobile != false || IschkEmail != false)) {

                    totalItemcnt = 1;
                    var SalesTeamHierarchyTypeId = $("input[name='hdnScanningTypeId']", this).val().trim();
                    EmpGroupId = $("input[name='hdnEmpGroupId']", this).val().trim();
                    RegionId = $("input[name='hdnRegionId']", this).val().trim();
                    //var RegionId = $("input[name='hdnRegionId']", this).val().split('-')[2];
                    ...
                    var obj = {
                        SalesTeamHierarchyTypeId: SalesTeamHierarchyTypeId,
                        EmpGroupId: EmpGroupId,
                        EmpId: EmpId,
                        RegionId: RegionId,
                        CustomerId: CustId,
                        IschkMobile: IschkMobile,
                        IschkEmail: IschkEmail,
                        IschkBoth: IschkBoth,
                        IsActive: IsActive,
                        IPAddress: IPAddress,
                        IsChange: IsChange
            ...
            if (IsValid) {
                var sv = $.ajax({
                    url: 'SalesTeamHierarchyMaster.aspx/SaveData',
                    type: 'POST',
                    //async: false,
                    dataType: 'json',
                    // traditional: true,
                    data: JSON.stringify({ hidJsonInputScanningType: CustomerData, IsAnyRowDeleted: $('#hdnIsRowDeleted').val(), DeletedIDs: $('#hdnDeleteIDs').val() }),
                    contentType: 'application/json; charset=utf-8'
                });
    ...
    <div class="panel panel-default">
        <div class="panel-body _masterForm">
            <div class="row">
                ...
                <div class="col-lg-2" id="div" runat="server" visible="false">
                    <div class="input-group form-group">
                ...
                <table id="tblCustomer" class="table table-bordered" border="1" tabindex="8" style="width: 100%; border-collapse: collapse; font-size: 10px;">
                    <thead>
                        <tr class="table-header-gradient">
                            ...
                            <th style="width: 9%; padding-left: 10px !important;">Region</th>
                ...
                <table id="gvScanningTypeHistory" class="gvScanningTypeHistory table table-bordered nowrap" style="width: 100%; font-size: 10px;">
                    <thead>
                        <tr class="table-header-gradient">
                            ...
                            <%--<th style="width: 10%">Employee</th>--%>
                            <%--  <th style="width: 10%">Dealer / Dist / SS / SLOC / Plant</th>--%>
                            <th style="width: 30%; text-align: left;">Keypad Entry</th>
                            <th style="width: 10%; text-align: left;">Camera Scanning</th>
                            <th style="width: 10%; text-align: left;">Both</th>
                            <th style="width: 3%;">Active</th>
