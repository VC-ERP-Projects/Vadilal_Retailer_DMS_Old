<%@ Page Title="" Language="C#" MasterPageFile="~/OutletMaster.master" AutoEventWireup="true" CodeFile="DealerFeedBack.aspx.cs" Inherits="Master_DealerFeedBack" %>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="input-group form-group" style="margin-bottom: 0px">
                       ...
                       <asp:DropDownList ID="ddlType" DataTextField="FeedbackName" DataValueField="FeedbackTypeID" runat="server" CssClass="ddlType form-control">
                                        </asp:DropDownList>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="input-group form-group">
                        ...
                        <asp:AutoCompleteExtender OnClientShown="resetPosition" CompletionListCssClass="CompletionListClass" ID="ACEtxtName" runat="server" ServiceMethod="GetDealerQuestion" OnClientPopulating="autoCompleteQues_OnClientPopulating" 
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="input-group form-group">
                        ...
                        <%--<asp:TextBox ID="txtPosibility" runat="server" CssClass="form-control allownumericwithdecimal" data-bv-notempty="true" data-bv-notempty-message="Field is required" autocomplete="off"></asp:TextBox>--%>
                    </div>
                </div>
            </div>
            <div class="row">
