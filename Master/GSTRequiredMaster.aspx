<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster.master" AutoEventWireup="true" CodeFile="GSTRequiredMaster.aspx.cs" Inherits="Master_GSTRequiredMaster" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(document).on('keyup', '.AutoDist', function () {
                ...
                $('#AutoDist' + col1).autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            type: "POST",
                            url: 'GSTRequiredMaster.aspx/SearchDistributor',
                            dataType: "json",
            ...
            $('.AutoDist').on('blur', function (e, ui) {
                ...
                if ($('#AutoDist' + col1).val().trim() != "") {
                    ...
                    CheckDuplicateData($('#AutoDist' + col1).val().trim(), col1, 2, "");
                }
            });
            //End Distributor
            ...
            $(document).on('keyup', '.AutoSS', function () {
                ...
                $('#AutoSS' + col1).autocomplete({
                    source: function (request, response) {
                        $.ajax({
                            type: "POST",
                            url: 'GSTRequiredMaster.aspx/SearchSuperStockiest',
                            dataType: "json",
                            data: "{ 'prefixText': '" + (textValue != '' ? textValue : '*') + "'}",
                            contentType: "application/json; charset=utf-8",
                            success: function (data) {
            ...
            $('.AutoSS').on('blur', function (e, ui) {
                ...
                if ($('#AutoSS' + col1).val().trim() != "") {
                    ...
                    CheckDuplicateData( "", col1, 3, $('#AutoSS' + col1).val().trim());
                }
            });
        ...
        function CheckDuplicateData(pDistCode, row3, ChkType, pSSCode) {
             
            var DistCode = "",  RSSCode = "";
            if (pDistCode != "") {
        ...
        function FillData() {
            ...
            var IsValid = true;
            $.ajax({
                url: 'GSTRequiredMaster.aspx/LoadData',
                type: 'POST',
                dataType: 'json',
                contentType: 'application/json; charset=utf-8',
                        ...
                        if (items.length > 0) {
                            ...
                            for (var i = 0; i < items.length; i++) {
                                ...
                                strEmp = "<tr id='trUserMap" + indE + "'>"
                                    ...
                                    + "<td id='tdRegion" + indE + "' class='tdRegion CustName'>" + items[i].Region + "</td>"
                                    + "<td id='tdBeatEmp" + indE + "' class='tdBeatEmp CustName'>" + items[i].BeatEmp + "</td>"
                                    ...
                                    + "<input type='hidden' class='hdnDistId' id='hdnDistId" + indE + "' name='hdnDistId' value='" + items[i].CustID + "'/>"
                                    + "<input type='hidden' class='hdnSSID' id='hdnSSID" + indE + "' name='hdnSSID' value='" + items[i].CustID + "'/>"
                                    + "<input type='hidden' class='hdnOCUMID' id='hdnOCUMID" + indE + "' name='hdnOCUMID' value='" + items[i].OCUMID + "' />"
        ...
        function ClearControls() {
            ...
            if ($('.chkIsReport').find('input').is(':checked')) {
                ...
                aryJSONColTable.push({ "width": "22px", "sClass": "dtbodyCenter", "aTargets": 6 });
                aryJSONColTable.push({ "width": "70px", "sClass": "dtbodyleft", "aTargets": 7 });
                    aryJSONColTable.push({ "width": "70px", "sClass": "dtbodyCenter", "aTargets": 8 });
        ...
        function AddMoreRow() {
            ...
            $('#AutoDist' + indE).on('blur', function (e, ui) {
                if ($('#AutoDist' + indE).val().trim() != "") {
                    ...
                    CheckDuplicateData($('#AutoDist' + indE).val().trim(), indE, 2, "");
                }
            });
            ...
            $('#AutoSS' + indE).on('blur', function (e, ui) {
                if ($('#AutoSS' + indE).val().trim() != "") {
                    ...
                    CheckDuplicateData("", indE, 3, $('#AutoSS' + indE).val().trim());
                }
            });
            //End Distributor textbox
        }
        function Cancel() {
            window.location = "../Master/GSTRequiredMaster.aspx";
        }
        ...
        function btnSubmit_Click() {
            ...
            if (IsValid) {
                var sv = $.ajax({
                    url: 'GSTRequiredMaster.aspx/SaveData',
                    type: 'POST',
                    //async: false,
                    dataType: 'json',
                    // traditional: true,
        ...
        function GetReport() {
            ...
            if ($('.chkIsReport').find('input').is(':checked')) {
                ...
                $('.gvUserUnitMapHistory tbody').empty();
                $.ajax({
                    url: 'GSTRequiredMaster.aspx/LoadReport',
                    type: 'POST',
                    dataType: 'json',
                    async: false,
                    contentType: 'application/json; charset=utf-8',
                        ...
                        if (result.d[0] == "" || result.d[0] == undefined) {
                            ...
                            for (var i = 0; i < ReportData.length; i++) {
                                ...
                                str = "<tr><td>" + k + "</td>"
                                    ...
                                    + "<td class='tdDist CustName'>" + ReportData[i].DistName + "</td>"
                                    + "<td class='tdss CustName'>" + ReportData[i].SSName + "</td>"
                                    + "<td class='tdRegion CustName'>" + ReportData[i].Region + "</td>"
                                    + "<td class='tdBeatEmp CustName'>" + ReportData[i].BeatEmp + "</td>"
                                 
                                    + "<td>" + ReportData[i].IsActive + "</td>"
                                  
                                 
                                    + "<td class='tdUpdateBy CustName'>" + ReportData[i].UpdatedBy + "</td>"
                ...
                if ($('.gvUserUnitMapHistory tbody tr').length > 0) {
                    ...
                    aryJSONColTable.push({ "width": "15px", "sClass": "dtbodyLeft", "aTargets": 5 });
                    aryJSONColTable.push({ "width": "60px", "sClass": "dtbodyLeft", "aTargets": 6 });
        ...
        function GetRegionEmpDetailsByDistSS(CustId, row) {
            ...
            $.ajax({
                url: 'GSTRequiredMaster.aspx/GetCustomerEmpDetails',
                type: 'POST',
                dataType: 'json',
                async: false,
                contentType: 'application/json; charset=utf-8',
    ...
    <style>
        ...
        dataTables_scroll .dataTables_scrollBody {
         ...
         #tblUserUnitMap_wrapper .dataTables_scrollBody {
            overflow-x: hidden !important;
            overflow-y: auto !important;
        }
                        ...
                        <div class="col-lg-3">
                            <div class="input-group form-group">
                                ...
                                <asp:DropDownList runat="server" ID="ddlOption" CssClass="ddlOption form-control" TabIndex="1" onchange="ShowDistOrSSOnChange();">
                                    <asp:ListItem Value="8" Selected="True">Distributor</asp:ListItem>
                                    <asp:ListItem Value="9">Super Stockist</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                            ...
                            <table id="tblUserUnitMap" class="table table-bordered" border="1" tabindex="8" style="border-collapse: collapse; font-size: 10px;">
                                <thead>
                                    <tr class="table-header-gradient">
                                        ...
                                        <th style="width: 15%; padding-left: 10px !important; text-align:left;" class="thDist">Distributor</th>
                                        <th style="width: 15%; padding-left: 10px !important;text-align:left;" class="thss">Super Stokiest</th>
                                        <th style="width: 10%; padding-left: 10px !important;text-align:left;">Region</th>
                                        <th style="width: 10%; padding-left: 10px !important;text-align:left;" class="thBeatEmp">Beat Employee</th>
                                        <th style="width: 3%; text-align: center; padding-left: 3px !important;">GST ?</th>
                                        <th ">Updated By</th>
                            ...
                            <table id="gvUserUnitMapHistory" class="gvUserUnitMapHistory table table-bordered nowrap" style="width: 100%; font-size: 10px;">
                                <thead>
                                    <tr class="table-header-gradient">
                                        ...
                                        <th style="width: 15%; padding-left: 10px !important; text-align:left;" class="thDist">Distributor</th>
                                        <th style="width: 15%; padding-left: 10px !important;text-align:left;" class="thss">Super Stokiest</th>
                                        <th style="width: 7%; padding-left: 10px !important;text-align:left;">Region</th>
                                        <th style="width: 8%; padding-left: 10px !important;text-align:left;" class="thBeatEmp">Beat Employee</th>
